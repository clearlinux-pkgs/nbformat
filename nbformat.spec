...
Source0  : https://files.pythonhosted.org/packages/a6/5a/af71b07b99eb2f6860add24206aad5e2e2afba2ab6a21682b725d6fbc413/nbformat-5.1.1.tar.gz
...
%prep
%setup -q -n nbformat-5.1.1
cd %{_builddir}/nbformat-5.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610649710
...
cp %{_builddir}/nbformat-5.1.1/COPYING.md %{buildroot}/usr/share/package-licenses/nbformat/4864371bd27fe802d84990e2a5ee0d60bb29e944
