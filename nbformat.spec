...
%prep
%setup -q -n nbformat-5.0.6
cd %{_builddir}/nbformat-5.0.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1587420378
...
cp %{_builddir}/nbformat-5.0.6/COPYING.md %{buildroot}/usr/share/package-licenses/nbformat/4864371bd27fe802d84990e2a5ee0d60bb29e944
